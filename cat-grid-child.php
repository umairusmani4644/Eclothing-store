...
$parent = mysqli_fetch_array(mysqli_query($conms, "SELECT name, parent FROM childcat WHERE id='".$iidd."'"));
...
$url0 = "$baseurl/childcategory/$iidd/".urlmod($parent[0]);
...
<?php echo $parent1[0]; ?></a><span>&rarr; </span></li>
            ...
            <li class="category13"><strong><?php echo $parent[0]; ?></strong></li>
...
<script>
 ...
 $(document).ready(function() {
        ...
        $.post( 
                  "<?php echo $baseurl;?>/api-child.php",
                  { 
          lstid: last,
          cid: "<?php echo $iidd; ?>"
          },
