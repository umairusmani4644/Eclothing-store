...
?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> <i class="fa fa-desktop"></i> View Feature List <small></small></h3>
					<hr>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
...
if(isset($_GET['did'])) {
$did = $_GET["did"];
$exist = mysqli_fetch_array(mysqli_query($conms, "SELECT COUNT(*) FROM features WHERE id='".$did."'"));
if($exist[0]>=1){
    
$res = mysqli_query($conms, "DELETE FROM features WHERE id='".$did."'");
