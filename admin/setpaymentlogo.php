...
?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"><i class="fa fa-cogs"></i> Set Payment Icons
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
...
$fnl = "$dt$random$ok";
                        ...
                        $newFileName=$fnl.".jpg";
                        move_uploaded_file($file_tmp=$_FILES["files"]["tmp_name"][$key],"../images/payment/".$newFileName);
 //$aa = "$aa,$newFileName";     
$cou++;
mysqli_query($conms, "INSERT INTO payment_icon SET img='".$newFileName."'");
...
?>                  
              ...
              <div class="col-sm-3"><b style="color:red; font-weight: bold;"> MULTIPLE IMAGE CAN BE UPLOADED <br> WILL FIR TO 60 X 40</b> </div>
...
if(isset($_GET['did'])) {
$did = $_GET["did"];
$exist = mysqli_fetch_array(mysqli_query($conms, "SELECT COUNT(*) FROM payment_icon WHERE id='".$did."'"));
if($exist[0]>=1){
    
$res = mysqli_query($conms, "DELETE FROM payment_icon WHERE id='".$did."'");
...
<img src=\"../images/payment/$data[1]\" alt=\"IMG\" style=\"width:100%; height:100px;\">
<br><br>
