...
?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"><i class="fa fa-edit"></i> EDIT  Payment Method
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
...
$res = mysqli_query($conms, "UPDATE payment SET name='".$name."', ins='".$ins."', need='".$need."' WHERE id='".$iidd."'");
...
$old = mysqli_fetch_array(mysqli_query($conms, "SELECT name, ins, need FROM payment WHERE id='".$iidd."'"));
?>  								
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
              <textarea id="" placeholder="" class="form-control" rows="2" name="ins"><?php echo $old[1]; ?></textarea>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
              <textarea id="" placeholder="" class="form-control" rows="2" name="need"><?php echo $old[2]; ?></textarea>
