...
$cpass = mysqli_fetch_array(mysqli_query($conms, "SELECT password FROM admin WHERE id='".$uid."'"));
...
if ($error == 0){
$passmd = MD5($newword);
$res = mysqli_query($conms, "UPDATE admin SET password='".$passmd."' WHERE id='".$uid."'");
if($res){
