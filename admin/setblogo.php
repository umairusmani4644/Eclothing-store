...
?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"><i class="fa fa-cogs"></i> Set Brand Logos
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
...
$fnl = "$dt$random$ok";
                        ...
                        $newFileName=$fnl.".jpg";
                        move_uploaded_file($file_tmp=$_FILES["files"]["tmp_name"][$key],"../images/brand/".$newFileName);
 //$aa = "$aa,$newFileName";     
$cou++;
mysqli_query($conms, "INSERT INTO brand_logo SET img='".$newFileName."'");
...
?>                  
              ...
              <div class="col-sm-3"><b style="color:red; font-weight: bold;"> MULTIPLE IMAGE CAN BE UPLOADED <br> WILL FIR TO 130 X 50</b> </div>
...
$exist = mysqli_fetch_array(mysqli_query($conms, "SELECT COUNT(*) FROM brand_logo WHERE id='".$did."'"));
if($exist[0]>=1){
    
$res = mysqli_query($conms, "DELETE FROM brand_logo WHERE id='".$did."'");
...
<img src=\"../images/brand/$data[1]\" alt=\"IMG\" style=\"width:100%; height:100px;\">
<br><br>
