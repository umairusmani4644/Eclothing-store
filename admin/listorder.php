...
?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> <i class="fa fa-desktop"></i> View All Orders <small></small></h3>
					<hr>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
...
$ddaa = mysqli_query($conms, "SELECT id, invid, usid, paydet, daddr, contactnum, code, tm, pst, dst, mst FROM orrdr ORDER BY id");
